...
<%@include file="admin_menu.jsp" %>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">图书管理</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="admin_user.jsp">新增图书</a><span class="crumb-step">&gt;</span><span>新增作品</span></div>
        </div>
